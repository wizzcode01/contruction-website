  ...
  const services = [
    {
      ...
      description: "We build spaces where dreams thrive, blending innovation and expertise to create lasting structures that inspire generations.",
      image: services1,
      delay: 0.5
    },
    {
      title: "Development Consultancy", 
      description: "Guidance rooted in experience, empowering clients to achieve their development goals with confidence.",
      image: services2,
      delay: 1
    },
    {
      title: "Project Management",
      description: "Efficiency and excellence from start to finish, keeping projects on track and teams aligned with precision and passion.",
      image: services3,
      delay: 1.5
    }
  ]
